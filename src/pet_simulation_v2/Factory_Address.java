 ...
 */
public class Factory_Address extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("The Not So Famous Factory");

        jLabel2.setText("Address : 5th RGB , Banana Street");

        jLabel3.setText("Factory Color : Pinkish");

        jLabel4.setText("Holding No : 11");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Factory_Address.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Factory_Address().setVisible(true);
            }
        });
    }
