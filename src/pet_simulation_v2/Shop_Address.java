 ...
 */
public class Shop_Address extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Creepy Pasta");

        jLabel2.setText("Address : 25th CMYK , Bla Bla State");

        jLabel3.setText("Shop Color : Yellow");

        jLabel4.setText("Holding No : 10");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Shop_Address.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Shop_Address().setVisible(true);
            }
        });
    }
